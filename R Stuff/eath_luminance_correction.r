...
nrow(P1)
ncol(P1)
fit<-earth( x = P1$Row, y=P1$xmax , nk = 20, nfold = 20, degree = 2, trace = 0) # ,ncross = 100, )
#fit<-earth( x = P1$xmin, y=PSI1$row , nk = 20, nfold = 20, ncross = 100, degree = 2, trace = 0, penalty = -1, newvar.penalty = 0, glm = NULL,  
